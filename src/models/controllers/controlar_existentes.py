...
class ControlarExistentes:
    ...
    def copiar_existes(self):
        """Iniciamos el hilo de trabajo"""
        hilo_trabajo = threading.Thread(target=self._procesar_y_copiar_existentes)
        hilo_trabajo.start()

    def mover_existentes(self):
        """Iniciamos el hilo de trabajo"""
        hilo_trabajo = threading.Thread(target=self._procesar_y_mover_existentes)
        hilo_trabajo.start()

    def eliminar_existentes(self):
        """Iniciamos el hilo de trabajo"""
        hilo_trabajo = threading.Thread(target=self._procesar_y_eliminar_existentes)
        hilo_trabajo.start()

    def papelara_existentes(self):
        """Iniciamos el hilo de trabajo"""
        hilo_trabajo = threading.Thread(target=self._procesar_y_papelera_existentes)
        hilo_trabajo.start()

    def _procesar_y_copiar_existentes(self):
    ...
    def _procesar_y_mover_existentes(self):
    ...
    def _procesar_y_eliminar_existentes(self):
    ...
    def _procesar_y_papelera_existentes(self):
