...
class ControlarVisualizacionDocumentos:
    ...
    def _crear_menus_contextuales(self):
        ...
        self.menu_contextual_tabla.add_command(label="📝 Comentario", command=self.menu_ops_tabla.on_comentario)
        ...
        self.menu_contextual_organizacion.add_command(label="📝 Comentario", command=self.menu_ops_organizacion.on_comentario)
        self.menu_contextual_organizacion.add_separator()
