...
class FrameSeleccionarColecciones(Frame):
    ...
    def panel_central(self, frame: Frame):
        ...
        container_colecciones = LabelFrame(paned_window, text="Colecciones", padding=5)
        ...
        ent_colecciones.pack(fill=X, padx=2, pady=(0, 5))

        self.frame_colecciones = ScrolledFrame(container_colecciones, padding=(1, 1))
        self.frame_colecciones.pack(fill=BOTH, expand=True, padx=2, pady=2)
