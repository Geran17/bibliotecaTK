...
class FrameVisualizarContenido(Frame):
    ...
    def __init__(self, master=None, **kwargs):
        ...
        self.controlador = ControlarVisualizarContenido(
    ...
    def crear_widgets(self):
        ...
        frame_busqueda.pack(fill=X, pady=(0, PADDING_PANEL))
    ...
    def actualizar_tabla(self):
        """
        Refrescar los datos del árbol de contenido.
        Limpia el árbol actual para refrescar los datos.
        """
