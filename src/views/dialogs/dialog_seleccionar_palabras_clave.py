...
from views.frames.frame_seleccionar_palabras_clave import FrameSeleccionarPalabrasClave


class DialogSeleccionarPalabrasClave(Toplevel):
    def __init__(self, title="Seleccionar palabras clave", **kwargs):
        super().__init__(title=title, **kwargs)
        # configuraciones de la ventana
        self.resizable(True, True)

        self.frame = FrameSeleccionarPalabrasClave(self)
