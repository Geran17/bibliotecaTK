...
from views.frames.frame_seleccionar_etiquetas import FrameSeleccionarEtiquetas


class DialogSeleccionarEtiquetas(Toplevel):
    def __init__(self, title="Seleccionar etiquetas", **kwargs):
        super().__init__(title=title, **kwargs)
        # configuraciones de la ventana
        self.resizable(True, True)

        self.frame = FrameSeleccionarEtiquetas(self)
